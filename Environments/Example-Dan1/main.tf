...
#   #source = "git::https://financeofamerica.visualstudio.com/FAH%20TF%20Program%20(Hosting)/_git/Terraform//Modules/Azure/Network?ref=Beta-v1.0"
#   vnet_name = "${var.AppName}_vNet"
#   resource_group_name = "${var.AppName}_Network_RG"
#   location = "${var.location}"
#   address_space = "${var.address_space}"
#   dns_servers = [""] #will use Azure DNS as default
#   subnet_prefixes = ["${var.subnet_prefixes}"]
#   subnet_names = ["${var.AppName}_sub1"]
#   allow_rdp_traffic = "true"
#   #allow_ssh_traffic = "true"
#   sg_name = "${var.AppName}_NSG"
#   tags = "${var.tags}"
# }
